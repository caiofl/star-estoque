...
<script type="text/javascript" src="{{ asset('js/scripts.js')}}"> </script>
  ...
  <div class="form-row">
    <div class="col-md-12 mb-3">
      ...
      <input type="text" class="form-control" id="nomeCliente" name="nomeCliente" minlength="3" required="">
    </div>
  </div>  
  ...
  <div class="form-row">
    <div class="col-md-8 mb-3">
      ...
      <input type="email" class="form-control" id="email" name="email" required="" pattern="\[0-9]{2}\ [0-9]{4,6}-[0-9]{3,4}$">
    </div>
    <div class="col-md-4 mb-3">
      <label for="telefone">Telefone:</label>
      <input type="text" class="form-control" id="telefone" name="telefone" required="" placeholder="(XX) XXXXX-XXXX" minlength="10" maxlength="11" pattern="\[0-9]{2}\ [0-9]{4,6}-[0-9]{3,4}$" 
  ...
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="estado" name="estado" required="" readonly="readonly">
    </div>
  </div>
